...
$sql= "SELECT * FROM `asset_registrationk` WHERE asset_ID=$asset_ID";
...
$sql = "UPDATE `asset_registrationk` 
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter name " name="asset_name" value="<?php echo $asset_name?>">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="input2">category</label>
                    <input type="text" class="form-control" id="input2" placeholder="Enter category " name="category" value="<?php echo $category?>">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control"  placeholder="Enter purchased_date " name="purchased_date"  value="<?php echo $purchased_date?>" >
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control" name="condition"  value="<?php echo $condition?>">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="input6" placeholder="Enter input 6" name="assinged_to"  value="<?php echo $assinged_to?>">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 center-input">
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="notes" placeholder="enter notes"  value="<?php echo $notes?>"></textarea>
                </div>
            </div>
        </div> 
...
echo ' <tr>
            ...
            <td>'.$notes.'</td>
          <td>
            <button class="btn btn-success"> <a href="form.php? asset_ID='.$asset_ID.'"class="text-light" >update</a></button>
